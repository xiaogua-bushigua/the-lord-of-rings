...
const Lightning = () => {
  return (
    <group>
      {/* 右上 */}
      <Lightning1 position={[0.9,0.3,0.1]} rotation={[0,0,-0.25]} initTime={0} scale={0.6}/>
      <Lightning1 position={[1,0.3,0.2]} rotation={[0,0,0.5]} initTime={5} scale={1}/>
      {/* 左上 */}
      <Lightning1 position={[-0.9,0.3,0.03]} rotation={[0,0,0.25]} initTime={10} scale={0.6}/>
      <Lightning1 position={[-1,0.3,0.035]} rotation={[0,0,-0.25]} initTime={15} scale={1}/>
      {/* 右下 */}
      <Lightning1 position={[0.9,-0.3,0.045]} rotation={[0,0,0.25]} initTime={20} scale={0.6}/>
      <Lightning1 position={[1,-0.3,0.04]} rotation={[0,0,-0.5]} initTime={25} scale={1}/>
      {/* 左下 */}
      ...
      {/* lightning2 */}
      <Lightning2 position={[1,0,0.065]} rotation={[0,0,-Math.PI/2]} scale={1.5} initTime={5}/>
      <Lightning2 position={[-1,0,0.07]} rotation={[0,0,Math.PI/2]} scale={1.5} initTime={10}/>
    </group>
  )
}
